[oracle@oasisrtspdb1 ~] cat odrmd9it_v11.rsp 
##############################################################################
##                                                                          ##
##                            DBCA response file                            ##
##                            ------------------                            ##
...
# Mandatory     : No
#-----------------------------------------------------------------------------
DATAFILEJARLOCATION =/u02/app/oracle/product/12.1.0/dbhome_3/assistants/dbca/templates/
...
# Mandatory     : No
#-----------------------------------------------------------------------------
DATAFILEDESTINATION =/data/ODC2C/ODCTC4/datafile
...
# Mandatory     : No
#-----------------------------------------------------------------------------
RECOVERYAREADESTINATION=/data/ODC2C/ODCTC4/archivelog
