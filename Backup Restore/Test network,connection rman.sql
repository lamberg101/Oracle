[Forwarded from Slamet Sigma]
Mas Slamet, Untuk test restore oppoin yang 48jam, 
saya curiga di badwithnya, Karena ZDLRA nya di BSDm targetnya di TBS.  Bisa kita test bandwithnya dulu ?

Troubleshooting Zero Data Loss Recovery Appliance Network Connectivity Issues (Doc ID 2721330.1)
