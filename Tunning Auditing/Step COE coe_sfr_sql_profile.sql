Cara Pantek SQL_ID ke Specific Hash Plan yang bagus

1. Jalankan script berikut (ada di server oem/exatbs)
Path script : /home/oracle/OI
@coe_xfr_sql_profile.sql
Value 1 : sqlid
Value 2 : hashplan value

Dengan input sqlid dan hashplan value yang bagus/kecil

2. Jalankan coe sesuai plan value
SQL> @coe_xfr_sql_profile_(sqlid)_(planvalue).sql


3. Check historical hash plan setelah 15 menit
Pastikan hash plan sudah mengarah ke plan value yang diinginkan


==============================================================================================================

[oracle@exa62tbspdb1-mgt OI]$ cat coe_xfr_sql_profile.sql 
