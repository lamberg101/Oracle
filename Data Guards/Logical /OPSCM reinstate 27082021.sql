...
3.----nohup impdp \"/ as sysdba\"  directory=STANDBY_DUMP dumpfile=IFM_TRC_REPOSITORY_072021_%U.dmp logfile=IMP_IFM_TRC_REPOSITORY_072021.log cluster=N
EXCLUDE=INDEX  parallel=4  & ( ON STANDBY OPSCM19 !!!! )
...
alter index DEDY_WIDYANTO.IFM_TRC_REPOSITORY par logging;
...
3.--nohup impdp \"/ as sysdba\"  directory=STANDBY_DUMP dumpfile=TRACE_LOG_TRANSACTION_082021_%U.dmp logfile=IMP_TRACE_LOG_TRANSACTION_082021.log cluster=N EXCLUDE=INDEX parallel=4  & ( ON STANDBY OPSCM19 !!!! )
...
3.--nohup impdp \"/ as sysdba\"  directory=STANDBY_DUMP dumpfile=TRACE_LOG_082021_%U.dmp logfile=IMP_TRACE_LOG_082021.log cluster=N EXCLUDE=INDEX  parallel=4  & 
( ON STANDBY OPSCM19 !!!! )
...
1.--nohup expdp \"/ as sysdba\"  directory=DATADUMP tables=TELKOMSEL.TCRPS114T dumpfile=TCRPS114T_082021_%U.dmp logfile=TCRPS114T_082021.log flashback_scn=disesuaikan parallel=4 &

2.DROP TABLE TELKOMSEL.TTRACE; ( on standby OPSCM19 !!!)

3.--nohup impdp \"/ as sysdba\"  directory=STANDBY_DUMP dumpfile=TCRPS114T_082021_%U.dmp logfile=IMP_TCRPS114T_082021.log cluster=N EXCLUDE=INDEX  parallel=4 & 
( ON STANDBY OPSCM19 !!!! )
...
========================================================TELKOMSEL.TCPUR043T=========================================================
1.--nohup expdp \"/ as sysdba\"  directory=DATADUMP tables=TELKOMSEL.TCPUR043T dumpfile=TCPUR043T_082021_%U.dmp logfile=TCPUR043T_082021.log flashback_scn=disesuaikan parallel=4  &

2.DROP TABLE TELKOMSEL.TCPUR043T; ( on standby OPSCM19 !!!)

3.--nohup impdp \"/ as sysdba\"  directory=STANDBY_DUMP dumpfile=TCPUR043T_082021_%U.dmp logfile=IMP_TCPUR043T_082021.log cluster=N EXCLUDE=INDEX parallel=4 & ( ON STANDBY OPSCM19 !!!! )

4.create index (Beluman)
